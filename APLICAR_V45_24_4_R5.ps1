...
Write-Host " V45.24.4 R5 - Moeda da Vitrine (PC maior + mais alta)" -ForegroundColor Cyan
Write-Host "======================================================" -ForegroundColor Cyan
Write-Host ""
...
# Desktop: crescer mais e subir mais; mobile fica como esta.
$content = Replace-Strict `
  $content `
  'width: clamp(152px, 13.2vw, 232px);' `
  'width: clamp(184px, 15.2vw, 274px);' `
  'largura desktop atual da moeda'

$content = Replace-Strict `
  $content `
  'top: 61.8%;' `
  'top: 58.2%;' `
  'top desktop atual da moeda'
...
Write-Host " - desktop largura: clamp(184px, 15.2vw, 274px)" -ForegroundColor White
Write-Host " - desktop top: 58.2%" -ForegroundColor White
...
Write-Host ""
Write-Host "V45.24.4 R5 concluida com sucesso." -ForegroundColor Green
