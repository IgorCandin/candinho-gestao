...
-- V38 · Inbox pausado.
-- A Central mantém o histórico das conversas, porém mensagens antigas
-- não entram como alerta/prioridade operacional enquanto o Inbox estiver pausado.
...
begin
  ...
  -- Inbox está pausado na operação atual.
  v_unread:=0;
  v_pending:=0;
