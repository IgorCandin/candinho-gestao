...
export type TestLabOperation = "supplements" | "fitness";
export type TestLabDashboardSummary = {
...
export type TestLabCustomer = { id: string; operation: TestLabOperation; name: string; phone: string | null };
export type TestLabSupplier = { id: string; operation: TestLabOperation; name: string };
export type TestLabSaleRow = {
  id: string;
  operation: TestLabOperation;
  customer_id: string;
  customer_name: string;
...
export type TestLabSaleDetails = TestLabSaleRow & { items: TestLabSaleItem[] };
export type TestLabPurchaseOrderRow = {
  id: string;
  operation: TestLabOperation;
  supplier_id: string;
  supplier_name: string;
...
export type TestLabPurchaseOrderItem = {
  id: string;
  purchase_order_id: string;
  product_id: string;
  product_name: string;
...
export type TestLabPurchaseOrderDetails = TestLabPurchaseOrderRow & { items: TestLabPurchaseOrderItem[] };
