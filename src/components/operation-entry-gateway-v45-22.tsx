...
const CONFIG = {
  ...
  supplements: {
    ...
    rgb: "217, 164, 65",
    items: [
      { href: "/suplementos/hoje", label: "Home", note: "Rotina da operação", icon: Home },
      ...
      { href: "/company/acoes-comerciais", label: "Despesa / baixa", note: "Avaria, uso interno e amostras", icon: PackageMinus },
      { href: "/suplementos/painel", label: "Gestão", note: "Indicadores gerenciais", icon: BarChart3 },
      { href: "/suplementos/nexus", label: "Nexus IA", note: "Análise e apoio à operação", icon: Bot },
    ],
  },
  fitness: {
  ...
  bank: {
    ...
    rgb: "70, 195, 123",
    items: [
      { href: "/bank", label: "Home", note: "Caixa e compromissos", icon: ChartNoAxesCombined },
