...
export function CompanyDayWorkspace({ events, summary }: { events: AgendaEvent[]; summary: AgendaSummary }) {
  ...
  return <div className="company-workspace-v2 company-day-v2">
    <header className="company-workspace-head"><div><span>COMPANY · CENTRO DO DIA</span><h1>Organizar o dia</h1><p>Agenda, prioridades, alertas e pendências em uma fila única de execução.</p></div><Link className="company-registry-link" href="/company/gestao/central/agenda"><Plus size={16}/> Nova tarefa</Link></header>
