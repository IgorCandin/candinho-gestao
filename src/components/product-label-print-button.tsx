...
function labelHtml(labels: ProductLabel[], copies: number) {
  ...
  return `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"/><title>Etiquetas Candinho</title><style>@page{size:80mm 140mm;margin:0}*{box-sizing:border-box}html,body{margin:0;background:#fff;color:#000;font-family:Arial,sans-serif}.label{width:80mm;height:136mm;padding:6mm 3.5mm 3mm;display:grid;grid-template-rows:15mm minmax(30mm,1fr) 22mm 35mm 14mm;gap:2mm;break-inside:avoid;page-break-inside:avoid;page-break-after:always;background:#fff}.label>*{min-height:0;border:.35mm solid #000;border-radius:4mm;break-inside:avoid;page-break-inside:avoid}.label-head{border:0;padding:0;display:flex;align-items:center;justify-content:center}.label-head img{display:block;width:55mm;max-height:14mm;object-fit:contain}.product{padding:4mm}.product h1{margin:1.5mm 0 0;font-size:17pt;line-height:1.1;overflow-wrap:anywhere;word-break:break-word}.variation{margin:1.7mm 0 0;font-size:10pt;font-weight:800}.product>span,.prices span,.barcode>span{font-size:7pt;font-weight:900;letter-spacing:.55px}.prices{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.prices div{display:grid;align-content:center;gap:1mm;padding:3.5mm}.prices div+div{border-left:.35mm solid #000}.prices b{font-size:16.5pt;line-height:1.05;white-space:nowrap}.barcode{padding:2.5mm;text-align:center;display:grid;grid-template-rows:auto 23mm auto;justify-items:center;align-content:center;gap:1mm}.barcode svg{display:block;width:60mm;height:23mm}.codes{display:grid;grid-template-columns:1fr 1fr;width:100%;gap:2mm}.codes strong{font-size:7pt;letter-spacing:.3px;white-space:nowrap}footer{padding:2.1mm;display:grid;gap:.5mm;text-align:center;align-content:center}footer strong{font-size:9.5pt}footer span{font-size:7pt;line-height:1.15}@media screen{body{padding:14px;background:#eee}.label{margin:0 auto 14px;box-shadow:0 1px 6px #777}}</style></head><body>${pages}<script>window.addEventListener('load',()=>window.print())<\/script></body></html>`;
}
