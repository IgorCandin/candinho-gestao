...
function reservationLabel(
  ...
  if (status === "reserved") {
    return `${reserved ?? requested ?? 0} reservada(s)`;
  }

  if (status === "partial") {
    return `${reserved ?? 0} de ${requested ?? 0} reservada(s)`;
  }
  ...
  return (
    <>
      ...
      <PageHeader
        ...
        description="Confira produtos, sabores, estoque, pagamentos, parcelas, entrega e informações internas da venda."
        action={
      ...
      <section className="sale-details-layout">
          ...
          <article className="panel">
            ...
            <div className="panel-body sale-items-list">
              {sale.items.map((item) => {
                ...
                return (
                  <div
                    className="sale-item-card detailed"
                    key={item.id}
                  >
                    ...
                    <div className="sale-item-copy">
                      ...
                      {reservationLabel(
                        ...
                        <small
                          className={`reservation-copy ${item.reservation_status}`}
                        >
                          {reservationLabel(
                            item.reservation_status,
                            item.quantity_reserved,
            ...
            <article className="panel">
              <div className="panel-head">
                <div>
                  <h2>Brinde</h2>
                  <p>
                    Produto incluído sem valor de venda e já
                    considerado no custo/lucro.
                  </p>
                </div>
                <Gift size={19} />
              </div>
              ...
              <div className="panel-body sale-detail-list">
                <DetailLine
                  label="Produto"
                  value={sale.gift_product_name}
                />
                <DetailLine
                  label="Quantidade"
                  value={`${sale.gift_quantity} un.`}
                />
              </div>
            </article>
          )}
          ...
          <article className="panel">
            <div className="panel-head">
              <div>
                ...
                <p>
                  Corrija o cliente, registre a entrega ou cancele a
                  venda. Pagamentos são controlados no painel acima.
                </p>
              </div>
            </div>
        ...
        <aside className="sale-details-side">
          ...
          <article className="panel">
            <div className="panel-head">
              <div>
                <h2>Datas e pagamento</h2>
                <p>Resumo operacional da venda</p>
              </div>
            ...
            <div className="panel-body sale-detail-list">
              <DetailLine
                ...
                value={formatDate(sale.order_at)}
              />
              <DetailLine
                label="Quitação integral"
                value={
                  sale.paid_at ? formatDate(sale.paid_at) : null
                }
              />
              <DetailLine
                ...
                value={
                  sale.payment_due_at
                    ? formatDateOnly(sale.payment_due_at)
                    : null
                }
              />
              <DetailLine
              ...
              />
              <DetailLine
                label="Forma / referência"
                value={sale.payment_method}
              />
              <DetailLine
                label="Situação do pagamento"
                value={sale.payment_condition}
              />
              <DetailLine
                label="Condição do preço"
                value={sale.price_condition}
              />
            </div>
          </article>
            ...
            <div className="panel-body sale-detail-list">
              ...
              <DetailLine
                ...
                value={
                  <span className="detail-with-icon">
                    <MapPin size={14} />
                    {sale.location_code} · {sale.location_name}
                  </span>
                }
              />
            </div>
          ...
          {sale.partner_name && (
            <article className="panel">
              <div className="panel-head">
                <div>
                  <h2>Parceria</h2>
                  <p>Venda contabilizada para o parceiro</p>
                </div>
                <Handshake size={19} />
              </div>
              <div className="panel-body sale-detail-list">
          ...
          {sale.notes && (
            <article className="panel">
              <div className="panel-head">
                <div>
                  <h2>Observações</h2>
                  <p>Informações adicionais da venda</p>
                </div>
