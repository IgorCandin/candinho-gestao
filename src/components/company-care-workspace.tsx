...
export type CompanyCareItem = { id: string; customerId: string; customerName: string; phone: string | null; city: string | null; operation: "Suplementos" | "Fitness"; kind: "post_sale" | "follow_up" | "waiting"; dueOn: string | null; title: string; note: string; href: string };
