        ...
        <div className="company-home-operations company-home-operations-primary">
          {access.canAccessSupplements && (
            <Link className="company-operation-card supplements" href="/suplementos">
              <div className="company-operation-logo-wrap"><Image src={BRAND_ASSETS.supplements.reduced.src} alt={BRAND_ASSETS.supplements.reduced.alt} width={BRAND_ASSETS.supplements.reduced.width} height={BRAND_ASSETS.supplements.reduced.height} /></div>
          ...
          {access.canAccessFitness && (
            <Link className="company-operation-card fitness" href="/fitness">
              <div className="company-operation-logo-wrap"><Image src={BRAND_ASSETS.fitness.reduced.src} alt={BRAND_ASSETS.fitness.reduced.alt} width={BRAND_ASSETS.fitness.reduced.width} height={BRAND_ASSETS.fitness.reduced.height} /></div>
              <div className="company-operation-mini-kpis">
          ...
          {marketingVisible && (
            <Link className="company-operation-card marketing" href="/marketing">
              <div className="company-operation-logo-wrap"><Image src={BRAND_ASSETS.marketing.reduced.src} alt={BRAND_ASSETS.marketing.reduced.alt} width={BRAND_ASSETS.marketing.reduced.width} height={BRAND_ASSETS.marketing.reduced.height} /></div>
              <div className="company-operation-mini-kpis">
        ...
        <div className="company-home-operations company-home-operations-secondary">
          {access.canAccessBank && (
            <Link className="company-operation-card bank" href="/bank">
              <div className="company-operation-logo-wrap"><Image src={BRAND_ASSETS.bank.reduced.src} alt={BRAND_ASSETS.bank.reduced.alt} width={BRAND_ASSETS.bank.reduced.width} height={BRAND_ASSETS.bank.reduced.height} /></div>
              <div className="company-operation-mini-kpis">
