...
import { LeadNexusMessageCard } from "@/components/lead-nexus-message-card";
    ...
    <div className="page-header-actions">
      {lead.quote_id && (
        <a
          ...
          href={`/api/orcamentos/${lead.quote_id}/pdf`}
          target="_blank"
          rel="noreferrer"
        >
          <FileText size={16} />
          ...
          <article className="panel budget-conversion-banner">
            <div className="panel-body">
              ...
              <div>
                ...
                <span>
                  Use “Converter em venda”. O sistema abre o fluxo de orçamento
                  já com este lead como origem. O lead só sai da lista depois da
          ...
          {lead.quote_id && (
            <article className="panel">
              <div className="panel-head">
                <div>
                  <h2>Orçamento #{lead.quote_number}</h2>
                  <p>Cotação vinculada a este lead.</p>
                </div>
                <FileText size={19} />
              </div>
              ...
              <div className="panel-body sale-detail-list">
                <Line
                  ...
                  value={
                    lead.quote_total_amount == null
                      ? null
                      : formatCurrency(lead.quote_total_amount)
                  }
                />
                <Line
                  label="Situação"
                  value={<Badge value={lead.quote_status ?? "quoted"} />}
                />
              </div>
            </article>
          )}
          ...
          <article className="panel">
            <div className="panel-head">
              <div>
                ...
                <p>
                  Antes de existir orçamento, produto e sabor podem ser
                  alterados pelo botão “Editar lead”.
                </p>
              </div>
          ...
          {lead.notes && (
            <article className="panel">
              <div className="panel-head">
                <div>
                  <h2>Observações</h2>
                  <p>Contexto do atendimento</p>
                </div>
                <MessageSquareText size={19} />
              </div>
              <div className="panel-body">
                <p className="sale-notes">{lead.notes}</p>
              </div>
            </article>
          )}
        </div>
          ...
          <article className="panel">
            ...
            <div className="panel-body sale-detail-list">
              ...
              <Line
                ...
                value={
                  <Badge
                    value={lead.lead_status ?? lead.general_status}
                  />
                }
              />
            </div>
