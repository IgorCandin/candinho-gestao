  ...
  return (
    <>
      ...
      <PageHeader
        ...
        description="Acompanhe itens a caminho, recebimentos parciais e vendas aguardando reposição."
        action={<Link className="button gold" href="/pedidos-fornecedor/novo"><Plus size={16} />Novo pedido</Link>}
      />
