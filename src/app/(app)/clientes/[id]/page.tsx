...
import { CustomerCompany360 } from "@/components/customer-company-360";
...
export default async function CustomerDetailsPage({
  ...
  const care =
    customer.sensitive_to_caffeine ||
    customer.anxiety_or_insomnia ||
    customer.prohibited_products ||
    customer.approach_preferences;
  ...
  return (
    <>
      ...
      <PageHeader
        eyebrow="Cliente"
        title={customer.name}
        description="Ficha comercial, cuidados de atendimento, visão Company, contatos, pós-venda e histórico completo."
        action={
      ...
      <div className="customer-radar-strip">
        <div>
          <Badge
            value={
              customer.radar_status
            }
          />

          <strong>
            {
              customer.next_action_label
            }
          </strong>
        </div>
      ...
      <section className="grid stats-grid customer-stats-grid">
        ...
        <StatCard
          ...
          note={`${customer.interaction_count} contato(s) no CRM`}
          icon={UserRound}
        />
      ...
      <section className="customer-profile-grid">
        <article className="panel">
          ...
          <div className="customer-profile-editor-wrap">
          ...
          <article className="panel customer-care-panel">
            ...
            <div className="panel-body sale-detail-list">
              {customer.sensitive_to_caffeine && (
                <Line
                  label="Cafeína"
                  value="Sensível à cafeína"
                />
              )}

              {customer.anxiety_or_insomnia && (
                <Line
                  label="Ansiedade/sono"
                  value="Possui ansiedade ou insônia"
                />
              )}

              <Line
                label="Produtos que não devem ser indicados"
                value={
                  customer.prohibited_products
                }
              />
              ...
              <Line
                label="Preferência de abordagem"
                value={
                  customer.approach_preferences
                }
              />
                    ...
                    >
                      ...
                      <td>
                        <Link
                          ...
                          href={`/pedidos-pendentes/${order.id}`}
                        >
                          Abrir
                        </Link>
                      </td>
                      ...
                      <td>
                        {lead.primary_product_id ? (
                          <Link
                            ...
                            href={`/produtos/${lead.primary_product_id}`}
                          >
