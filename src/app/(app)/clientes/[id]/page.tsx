  ...
  return (
    <>
      ...
      <section className="grid stats-grid customer-stats-grid">
        ...
        <StatCard href="/vendas" label="Total comprado" value={formatCurrency(customer.total_spent)} note="Histórico de vendas" icon={ShoppingBag} />
        ...
        <StatCard href="/agenda" label="Próxima ação" value={customer.next_followup_at ? formatDateOnly(customer.next_followup_at) : "Livre"} note={customer.next_action_label} icon={CalendarClock} />
      </section>
