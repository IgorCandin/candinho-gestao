    ...
    <section className="bank-dashboard">
      <div className="page-header bank-page-header">
        ...
        <div className="bank-header-actions">
          <Link className="button ghost" href="/bank/contas?acao=atualizar-saldo"><RefreshCcw size={16} />Atualizar saldo</Link>
      ...
      <div className="bank-quick-actions">
        <Link href="/bank/contas?acao=atualizar-saldo" className="bank-quick-card">
          <RefreshCcw size={20} />
          <div><strong>Atualizar saldo</strong><span>Informe o valor atual de todas as contas.</span></div>
          <ArrowRight size={17} />
        </Link>
