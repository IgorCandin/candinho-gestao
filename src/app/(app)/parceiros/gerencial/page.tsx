...
export default async function PartnerManagementPage(){
  ...
  return <>
    <DemoBanner/>
    <PageHeader eyebrow="Parceiros" title="Área Gerencial" description="Indicadores internos, acessos do Portal Parceiro e vendas antigas que ainda precisam de vínculo." action={<Link className="button ghost" href="/parceiros"><ArrowLeft size={16}/>Voltar aos parceiros</Link>}/>
    <section className="stats-grid partner-stats-grid">
      ...
      <StatCard href="/parceiros/gerencial" label="Portais ativos" value={String(portal.active_portals)} note={`${portal.without_portal_count} parceiro(s) sem login`} icon={KeyRound}/>
