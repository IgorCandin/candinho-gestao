...
Write-Host " V45.24.4 R6 - Moeda da Vitrine (PC sobe mais)" -ForegroundColor Cyan
Write-Host "======================================================" -ForegroundColor Cyan
Write-Host ""
...
# Ajuste incremental sobre a R5.
$content = Replace-Strict `
  $content `
  'width: clamp(184px, 15.2vw, 274px);' `
  'width: clamp(228px, 18.2vw, 336px);' `
  'largura desktop atual da moeda (R5)'

$content = Replace-Strict `
  $content `
  'top: 58.2%;' `
  'top: 52.8%;' `
  'top desktop atual da moeda (R5)'
...
Write-Host " - desktop largura: clamp(228px, 18.2vw, 336px)" -ForegroundColor White
Write-Host " - desktop top: 52.8%" -ForegroundColor White
...
Write-Host ""
Write-Host "V45.24.4 R6 concluida com sucesso." -ForegroundColor Green
