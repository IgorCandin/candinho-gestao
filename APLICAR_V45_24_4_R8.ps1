...
Write-Host " V45.24.4 R8 - Sobe moeda no PC e no mobile" -ForegroundColor Cyan
Write-Host "======================================================" -ForegroundColor Cyan
Write-Host ""
...
# Incremental sobre a R7: so sobe, sem alterar tamanho/left.
$content = Replace-Strict `
  $content `
  'top: 48.6%;' `
  'top: 44.2%;' `
  'top desktop atual da moeda (R7)'

$content = Replace-Strict `
  $content `
  'top: 71.8%;' `
  'top: 69.2%;' `
  'top mobile atual da moeda'
...
Write-Host " - desktop top: 44.2%" -ForegroundColor White
Write-Host " - mobile top: 69.2%" -ForegroundColor White
Write-Host " - tamanho e alinhamento horizontal mantidos" -ForegroundColor White
...
Write-Host ""
Write-Host "V45.24.4 R8 concluida com sucesso." -ForegroundColor Green
